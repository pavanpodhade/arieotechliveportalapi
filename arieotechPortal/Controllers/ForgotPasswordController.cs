...
namespace ArieotechLive.Controllers
{
    ...
    public class ForgotPasswordController : ControllerBase
    {
        ...
        #region ctor
        public ForgotPasswordController(ILoggerManager loggerManager,
        ...
        public ActionResult GetUserByForgotPasswordToken(string fptoken)
        {
            ...
            try
            {
                ...
                forgotPasswordModel = this.forgotPasswordrepository.GetUserByForgotPasswordToken(fptoken);
              

                result = Ok(forgotPasswordModel);
        ...
        public ActionResult ForgotPassword(string email)
        {
            ...
            try
            {
                ...
                if (userfromdb != null)
                {
                    ...
                    this.forgotPasswordrepository.AddForgotPassword(model);
