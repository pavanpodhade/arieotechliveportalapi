...
namespace ArieotechLive.Controllers
{
    ...
    [ApiController]
    public class ForgotPasswordHistoryController : ControllerBase
    {
        #region Private Vars 
        private readonly ILoggerManager loggerManager;
        private readonly IForgotPasswordHistory forgotPasswordHistory;
        ...
        #region ctor
        public ForgotPasswordHistoryController(ILoggerManager loggerManager,
                                                IForgotPasswordHistory forgotPasswordHistoryRepository,
                                                IUserRepositiory userRepository,
                                                IConfiguration configuration,
                                                IUsageActivityRepository usageActivityRepository)
        {
            this.loggerManager = loggerManager;
            this.forgotPasswordHistory = forgotPasswordHistoryRepository;
        ...
        public ActionResult ForgotPassword(string email)
        {
            ...
            try
            {
                ...
                //Calculate Email            
                User userfromdb = this.userRepository.GetUserByEmail(email);
                if (userfromdb != null)
                {
                 ...
                 /*  new ControllerHelper().UsageActivityLogin(this.usageActivityRepository, ActivityTypeEnum.UserForgetPassword, -1, userfromdb.Id, authResult.LoginSessionId = "");
        ...
        public ActionResult ResetPassword(int userid, string password, string fptoken)
        {
            ...
            try
            {
               ...
               Tuple<string, string> hashTuple = new ControllerHelper().ComputeHash(password);
                ...
                new ControllerHelper().UsageActivityLogin(this.usageActivityRepository, ActivityTypeEnum.UserResetPassword, -1, userid,authResult.LoginSessionId = "");
